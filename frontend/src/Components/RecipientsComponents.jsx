      ...
      <div className="w-[20%] flex flex-col overflow-hidden h-full">
        ...
        >
          ...
          {recipients.map((ele, index) => {
            ...
            return (
              <div
                className="flex flex-row bg-[rgba(220,220,220,0.5)] rounded-lg p-1 items-center shadow-sm shadow-gray-800 mb-[0.5px]"
                key={index}
              >
                <div
          ...
          <div
            className="flex flex-row bg-[rgba(20,20,20,0.5)] rounded-lg p-1 items-center shadow-sm shadow-gray-800 mb-[0.5px]"
            onClick={handleClick}
          >
            <div
              className="w-[40px] h-[40px] rounded-lg flex items-center justify-center"
